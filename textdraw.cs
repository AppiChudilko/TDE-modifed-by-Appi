...
public class TextDraw : Script 
{
	...
	[Command("tdcolor", "/tdcolor [red] [green] [blue] [alpha] (0-255)", Alias = "tdcl")]
	public void TdColor(Client playerid, int r,int g, int b, int a)
	{
		if(r < 0 || r > 255 || g < 0 || g > 255 || b < 0 || b > 255 || a < 0 || a > 255)
		{
			API.sendNotificationToPlayer(playerid, "Invalid rgba color (min 0, max 255)");
			return;
		}
		API.triggerClientEvent(playerid, "TDColor", r,g,b,a);
	}
