...
{
	API.sendChatMessage("TDE Editor 0.1.1 by ~r~[RW]Robi~w~. Edited by ~r~Appi");
...
API.onServerEventTrigger.connect(function (eventName, args) 
{
	switch(eventName)
	{
		...
		case "TDColor":
		{
			...
			TextDrawR[SelectedTD] = args[0]; TextDrawG[SelectedTD] = args[1]; TextDrawB[SelectedTD] = args[2]; TextDrawA[SelectedTD] = args[3];
			break;
		}
		case "TDFont":
		{
